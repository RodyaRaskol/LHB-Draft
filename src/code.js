...
function BuildFoodNaviBar(mySubPage) {
   ...
   /* "ingredients": { id: "fmIngredients", page: "ingredients.html",display:"Ingredients" }*/
    ...
    bar += '<div class="subnav-left-side">';
        for (var i = 0; i < foodmenus.length; i++) {
               mySubMenu= '<div id="'+foodmenus[i][0]+'" class="subnav-link-wrapper"><a href="'+foodmenus[i][1]+'">'+foodmenus[i][2]+'</a></div>';
                bar += mySubMenu;
            }
    bar += '</div>';//Close Left
